! function (a) {
    ...
    a.fn.modalSteps = function (b) {
        var c = this,
            ...
            f = function (a,o) {
                return void 0 !== a && "function" == typeof a ? (a(o), !0) : !1
            };
        return c.on("show.bs.modal", function () {
        ...
        }), c.find(".js-btn-step").on("click", function (bo) {
            ...
            var validado = true;
            if ($(bo.currentTarget).data("orientation") == "next") {
                validado = d.validar(c.find("div[data-step=" + j.val() + "]"));
            }
